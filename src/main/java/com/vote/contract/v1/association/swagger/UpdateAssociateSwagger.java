...
@ApiOperation(value = "Atualiza associado", response = AssociateContractResponse.class,
...
@ApiResponses({
    ...
    @ApiResponse(code = 409, message = "Conflito na atualização do associado"),
    @ApiResponse(code = 500, message = "Internal error", response = Error.class)
})
public @interface UpdateAssociateSwagger {
}
