...
@ApiOperation(value = "Busca todas pautas", response = AssociateContractResponse.class,
...
@ApiResponses({
    ...
    @ApiResponse(code = 409, message = "Conflito ao buscar pauta"),
    @ApiResponse(code = 500, message = "Internal error", response = Error.class)
})
public @interface FindAllSchemesSwagger {
}
